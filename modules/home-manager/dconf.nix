...

{
  dconf.settings = {
    ...
    "org/gnome/settings-daemon/plugins/media-keys" = {
      custom-keybindings = [ "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom0/" "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom3/" "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom1/" "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom2/" ];
      decrease-text-size = [ ];
      help = [ ];
      home = [ ];
      magnifier = [ ];
    ...
    "org/gnome/shell" = {
      ...
      disabled-extensions = [ "dash-to-dock@micxgx.gmail.com" "pano@elhan.io" ];
      enabled-extensions = [ "user-theme@gnome-shell-extensions.gcampax.github.com" "dash-to-panel@jderose9.github.com" "appindicatorsupport@rgcjonas.gmail.com" "netspeedsimplified@prateekmedia.extension" "gsconnect@andyholmes.github.io" "blur-my-shell@aunetx" "panel-date-format@keiii.github.com" "noannoyance-fork@vrba.dev" "gtk4-ding@smedius.gitlab.com" "tiling-assistant@leleat-on-github" "lockkeys@vaina.lt" "Shortcuts@kyle.aims.ac.za" "miniview@thesecretaryofwar.com" "bluetooth-quick-connect@bjarosze.gmail.com" "clipboard-history@alexsaveau.dev" ];
    ...
    "org/gnome/shell/extensions/tiling-assistant" = {
      ...
      tile-bottomleft-quarter = [ "<Super>KP_End" ];
      ...
      tile-right-half = [ "<Super>Right" "<Super>KP_Right" ];
      tile-right-half-ignore-ta = [ ];
      tile-top-half = [ "<Super>KP_Up" ];
      tile-top-half-ignore-ta = [ ];
      tile-topleft-quarter = [ "<Super>KP_Home" ];
      tile-topleft-quarter-ignore-ta = [ ];
      tile-topright-quarter = [ "<Super>KP_Page_Up" ];
