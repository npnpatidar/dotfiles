...
class Document:
    ...
    def get_bookmarks(self):
        ...
        bookmarks = [Bookmark(self, desc, y_offset) for _, _, desc, _, _, _, _, _, _, _, _, _, _, _, _, y_offset in cursor.fetchall()]
        return bookmarks
    ...
    def get_highlights(self):
        ...
        highlights = [Highlight(self, text, highlight_type, (begin_x, begin_y), (end_x, end_y)) for _, _, text, _, highlight_type, _, _, _, begin_x, begin_y, end_x, end_y in cursor.fetchall()]
        return highlights
